...
public enum EditAddressMapCalloutState {
...
public func !=(lhs: EditAddressMapCalloutState, rhs: EditAddressMapCalloutState) -> Bool {
    return !(lhs == rhs)
}
...
protocol EditAddressMapCalloutDelegate: class {
    func editAddressMapCalloutDidSubmit(_ node: EditAddressMapCalloutNode)
}

class EditAddressMapCalloutNode: ASDisplayNode {
    ...
    weak var delegate: EditAddressMapCalloutDelegate?
    
    var state: EditAddressMapCalloutState = .loading {
        didSet {
