...
protocol FiltersOneColumnLayoutDelegate: ASCollectionDelegate {
...
class FiltersOneColumnLayout: UICollectionViewFlowLayout {
    var delegate: FiltersOneColumnLayoutDelegate!
