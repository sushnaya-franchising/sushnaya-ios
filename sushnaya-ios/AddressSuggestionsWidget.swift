...
protocol AddressSuggestionsProvider: class {
    func requestSuggestions(forQuery query: String) -> Promise<[String]?>
    @discardableResult
    func cancelAllRequests() -> Promise<()>
}

class DadataSuggestionsProvider: AddressSuggestionsProvider {
...
class AddressSuggestionsWidget: NSObject {
    ...
    var provider: AddressSuggestionsProvider?
    weak var delegate: AddressSuggestionsWidgetDelegate?
...
extension AddressSuggestionsWidget: ASTableDataSource, ASTableDelegate {
    ...
    func tableNode(_ tableNode: ASTableNode, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.addressSuggestionsWidget(self, didSelectSuggestion: suggestion)
    }
}
