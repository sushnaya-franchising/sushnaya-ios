...
class SignInPagerNode: ASDisplayNode {
    static let introHeadings = [
        (header: "Добро пожаловать в Сушную!", subheading: "Больше не нужно никуда звонить, самые вкусные роллы и пицца - в твоем мобильном"),
        (header: "Доставим за 1 час", subheading: "Если мы не успеем доставить ваш заказ за час, вы получите гарантированную скидку 50%"),
        (header: "Статус заказа", subheading: "Прямо в приложении вы можете отслеживать, что происходит с вашим заказом")
    ]
