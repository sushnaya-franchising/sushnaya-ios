...
struct Constants {
    ...
    struct CartLayout {
        ...
        static let RecommendationImageSize = CGSize(width: 48, height: 48)
        static let RecommendationCornerRadius:CGFloat = 11
        static let RecommendationTitleStringAttributes:[String: Any] = {
            let paragraphStyle = NSMutableParagraphStyle()
            paragraphStyle.alignment = .center
