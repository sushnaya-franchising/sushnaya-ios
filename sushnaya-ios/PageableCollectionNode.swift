...
//        return Int(floor(view.contentOffset.x / pageWidth))
//    }
//
//    var pageNumberAfterLeftMostVisiblePage: Int {
//        return Int(floor((view.contentOffset.x + pageWidth) / pageWidth))
//    }
//
...
//        return view.contentSize.width - pageWidth
//    }
//
//    override func didLoad() {
//        super.didLoad()
//        view.addGestureRecognizer(UIPanGestureRecognizer(target: self, action: #selector(CollectionNodeWithCustomizedPaging.didPanGesture(_:))))
//    }
//
//    func didPanGesture(_ recognizer: UIPanGestureRecognizer) {
//        if view.isPagingEnabled && maxOffsetX > 0 {
...
//
//        view.contentOffset.x -= translationX
//
//        delegate?.collectionNodeDidScroll?(view)
//    }
//
//    fileprivate func getTranslationX(_ recognizer: UIPanGestureRecognizer) -> CGFloat {
//        let translation = recognizer.translation(in: view)
//
//        return (view.contentOffset.x > maxOffsetX || view.contentOffset.x < 0) ?
...
//            horizontalPagingDelegate?.collectionViewWithHorizontalPaging?(
//                willTurnPage: currentPageNumber, velocity: velocity)
//
//            completionBlock = { _, finished in
//                if finished {
//                    let didTurnPage = self.currentPageNumber
//                    self.currentPageNumber = closestPageNumber
//                    self.horizontalPagingDelegate?.collectionViewWithHorizontalPaging?(
//                        didTurnPage: didTurnPage)
//                }
//            }
//        }
//
...
//
//        pop_add(animation, forKey: kPagingAnimationKey)
//    }
//
