//
//  HorizontalLinearFlowLayout.swift
//  sushnaya-ios
//
...
public class HorizontalLinearFlowLayout: UICollectionViewFlowLayout {
    ...
    static func configureLayout(collectionView: UICollectionView, itemSize: CGSize, minimumLineSpacing: CGFloat) -> HorizontalLinearFlowLayout {
        let layout = HorizontalLinearFlowLayout()
    ...
    private func configureInset() -> Void {
        ...
        let inset = self.collectionView!.bounds.width / 2 - self.itemSize.width / 2
        self.collectionView!.contentInset = UIEdgeInsetsMake(0, inset, 0, inset)
        self.collectionView!.contentOffset.x = -inset
    }
